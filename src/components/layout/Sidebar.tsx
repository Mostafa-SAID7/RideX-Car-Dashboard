...
const Sidebar: React.FC = () => (
  <aside className="pill-surface sidebar-pill">
    {/* Overview */}
    <NavLink to="/" end className={({ isActive }) => `sidebar-icon${isActive ? ' active' : ''}`}>
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
    </NavLink>
    {/* Buy */}
    <NavLink to="/buy" className={({ isActive }) => `sidebar-icon${isActive ? ' active' : ''}`}>
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
    </NavLink>
    {/* Sell */}
    <NavLink to="/sell" className={({ isActive }) => `sidebar-icon${isActive ? ' active' : ''}`}>
    ...
    {/* Rent */}
    <NavLink to="/rent" className={({ isActive }) => `sidebar-icon${isActive ? ' active' : ''}`}>
