      ...
      <main className="main-content">
        <header className="topbar">
          <div className="top-nav">
            ...
            <span className="nav-pill">Buy</span>
            <span className="nav-pill">Sell</span>
            <span className="nav-pill">Rent</span>
          </div>
